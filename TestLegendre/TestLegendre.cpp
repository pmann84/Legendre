...
TEST(TestLegendre, LegendreEvaluateAtM0L0)
{
	...
	ASSERT_DOUBLE_EQ(legendre(0.5), 1.0);
}
...
TEST(TestLegendre, LegendreEvaluateAtM1L1)
{
	...
	int m = 1;
	AssociatedLegendre legendre(l, m);
	ASSERT_DOUBLE_EQ(legendre(0.5), -0.8660254037844386);
}
...
TEST(TestLegendre, LegendreEvaluateAtM1L2)
{
	...
	int m = 1;
	AssociatedLegendre legendre(l, m);
	ASSERT_DOUBLE_EQ(legendre(0.5), -1.299038105676658);
}
...
TEST(TestLegendre, LegendreEvaluateAtM1L3)
{
	...
	int m = 1;
	AssociatedLegendre legendre(l, m);
	ASSERT_DOUBLE_EQ(legendre(0.5), -0.3247595264191645);
}